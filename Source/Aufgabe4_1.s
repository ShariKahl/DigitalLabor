...
main:
    ...
    //Drei mal Funktion function1 aufrufen
    bl function1 
    bl function1 
    bl function1 
...
function1:
    stmfd sp!,{r0,r1,lr}            // r0, r1 auf dem Stack speichern/retten, Linkregister auf dem Stack speichern, Fkt verwendet r0, r1 fr temporre Daten.

    add sp, #-8

    mov r0, #5                      // Lokale 8Bit Variable a mit dem Wert 5 initialisieren
    strb r0,[sp,#2]                 // 8 Bit Variable auf dem Stack ablegen 2 Bytes vom Stapelzeiger (Speichern von Bytes)

    mov r0, #-6                     // Lokale 16Bit Variable b mit dem Wert -6 initialisieren
    strh r0,[sp]                    // 16 Bit Variable auf dem Stack ablegen (Speichern von Half-Words)
...
function2:
    ...
    rsbmi r0,r0,#0                  // Falls das Ergebnis negativ ist, invertiere es (Umgekehrte Subtraktion)
